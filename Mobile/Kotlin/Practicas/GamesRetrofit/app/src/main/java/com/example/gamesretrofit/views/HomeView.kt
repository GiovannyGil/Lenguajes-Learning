...
import com.example.gamesretrofit.components.Loarder
...
fun ContentHomeView(viewModel: GamesViewModel, pad:PaddingValues, navController: NavController){
    ...
    Column(modifier = Modifier.padding(pad), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        LazyColumn(
            ...
            when(gamesPage.loadState.append){
                ...
                is LoadState.Error -> {
                    item { Text(text = "Error Al Cargar") }
                }
            }
        }
    }
