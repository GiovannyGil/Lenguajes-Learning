...
function generate(data) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      rpt.image('./imagen/Comunion/LogoEntidad.PNG');
      rpt.newLine(2);
      ...
      rpt.print('COOPERATIVA DE AHORROS Y CREDITO UNION COLOMBIANA', {
        align: 'center',
      });
      rpt.print('CERTIFICA:', {
        align: 'center',
      ...
      rpt.print(`Que ${data['#NOMBRE#']}, identificado(a) con ${data['#TIPODOCUMENTO#']} número ${data['#CEDULA#']} como deudor, adeuda a la COOPERATIVA DE AHORROS Y CREDITO UNION COLOMBIANA  la suma de ${data['#VALORLETRAS#']} pesos ($${data['#VALORDEUDA#']}),saldo a la fecha por concepto de créditos.`, {
        align: 'left',
      });
