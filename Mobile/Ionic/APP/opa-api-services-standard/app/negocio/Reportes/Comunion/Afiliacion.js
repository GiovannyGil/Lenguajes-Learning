...
function generate(data) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      ...
      rpt.print(`Que ${data['#NOMBRE#']}, identificado(a) con ${data['#TIPODOCUMENTO#']} número ${data['#CEDULA#']} de ${data['#CIUDAD#']}, es Asociado (a) a la COOPERATIVA DE AHORROS Y CREDITO UNION COLOMBIANA y se encuentra vinculado desde ${data['#FECHA#']}.`, {
        align: 'left',
      });
