...
function generate(data, dataR) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      ...
      // rpt.print("FONDO DE EMPLEADOS FEISA", {
      ...
      rpt.print('CERTIFICADO ANUAL DE RETENCIÓN EN LA FUENTE E INFORMACION INFORMACIÓN', {
        align: 'center',
      });
      rpt.newLine(1);
      ...
      let imgLoc = '';
      if (fs.existsSync('./imagen/Femfuturo/LogoEntidad.PNG')) {
        imgLoc = './imagen/Femfuturo/LogoEntidad.PNG';
        rpt.image(imgLoc);
      } else {
      ...
      rpt.print('Este certificado no requiere firma autógrafa al expedirse por medio de computador ', {
        align: 'center',
      });
      ...
      rpt.print(`Teléfono: ${dataR.telefono}`, {
        align: 'center',
      });
