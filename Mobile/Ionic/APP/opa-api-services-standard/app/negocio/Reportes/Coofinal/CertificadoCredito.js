...
function generate(data) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      ...
      rpt.print('COOPERATIVA DE AHORRO Y CREDITO DE TENJO', {
        align: 'center',
      });
      rpt.print('CERTIFICA:', {
        align: 'center',
      ...
      rpt.print(`Que ${data['#NOMBRE#']}, identificado(a) con ${data['#TIPODOCUMENTO#']} número ${data['#CEDULA#']} como deudor, adeuda a la COOPERATIVA DE AHORRO Y CREDITO DE TENJO la suma de ${data['#VALORLETRAS#']} pesos ($${data['#VALORDEUDA#']}),saldo a la fecha por concepto de créditos.`, {
        align: 'left',
      });
