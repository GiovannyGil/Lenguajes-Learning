...
function generate(data) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      rpt.image('./imagen/Comerciacoop/LogoEntidad.PNG');
      rpt.newLine(2);
      ...
      rpt.print('LA COOPERATIVA DE AHORRO Y CRÉDITO COMERCIACOOP', {
        align: 'center',
      });
      rpt.print('CERTIFICA:', {
        align: 'center',
      ...
      rpt.print('COOPERATIVA DE AHORRO Y CRÉDITO COMERCIACOOP');
