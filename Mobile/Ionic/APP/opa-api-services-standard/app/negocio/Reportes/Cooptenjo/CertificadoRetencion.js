...
function generate(data, dataR) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      rpt.image('./imagen/Cooptenjo/LogoEntidad.PNG');
      rpt.newLine(2);
      ...
      if (fs.existsSync('./imagen/Cooptenjo/LogoCpio.PNG')) {
        rpt.image('./imagen/Cooptenjo/LogoCpio.PNG');
      } else {
      ...
      rpt.print(`E-mail: ${dataR.email} - Web: www.femfuturo-gana.com.co`, {
        align: 'center',
      });
    };
