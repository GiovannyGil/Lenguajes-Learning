...
function generate(data, dataR) {
  const promise = new RSVP.Promise((resolve, reject) => {
    const header = (rpt) => {
      rpt.image('./imagen/Cooprocal/LogoEntidad.PNG');
      rpt.newLine(2);
      ...
      if (fs.existsSync('./imagen/Cooprocal/LogoCpio.PNG')) {
        rpt.image('./imagen/Cooprocal/LogoCpio.PNG');
      } else {
      ...
      rpt.print(`E-mail: ${dataR.email} - Web: www.cooprocal.com`, {
        align: 'center',
      });
    };
